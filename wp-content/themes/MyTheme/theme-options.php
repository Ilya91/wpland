	...
	<div class="wrap">
		...
		<form method="post" action="options.php" enctype="multipart/form-data">
			...
			<table class="form-table">
				...
				<tr valign="top"><th scope="row"><?php _e( 'Фоновое изображение', 'sampletheme' ); ?></th>
					<td>
						<?php esc_attr_e( $options['file'] ); ?>
					</td>
					<td>
						<input id="sample_theme_options[file]" class="regular-text" type="file" name="sample_theme_options[file]" value="<?php esc_attr_e( $options['file'] ); ?>" />
					</td>
				</tr>
